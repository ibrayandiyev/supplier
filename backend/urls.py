...
from .views import Suppliers, SupplierAdd, SupplierUpdate, SupplierDetail, SupplierContactAdd
...
from .views import Stocks, StocksFavorite, StockAdd, StockUpdate
...
from .views import Categories, ajax_add_category, ajax_delete_category
...
from .views import ajax_add_favorite_groups, ajax_delete_group_favorite
...
from .views import ajax_command_record_datetime

from .views import Boxs, BoxsFavorite, BoxAdd, BoxUpdate
from .views import ajax_import_boxs, ajax_delete_boxs, ajax_list_boxs, ajax_grid_boxs
from .views import ajax_add_favorite_boxs, ajax_delete_box_favorite
